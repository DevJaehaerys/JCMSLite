<template>
    <div class="flex ">
        ...
        <label for="drawer-toggle"
               class="fixed top-2/4 left-0 inline-block p-4 transition-all duration-500 bg-base-300 rounded-lg z-50 peer-checked:rotate-180 peer-checked:left-64">
            <div class="w-6 h-1 mb-3 -rotate-45 bg-base-100/100 rounded-lg"></div>
            <div class="w-6 h-1 rotate-45 bg-base-100/100 rounded-lg"></div>
        </label>
        <div
            class="fixed top-0 left-0 z-20 w-64 h-full transition-all flex justify-center items-center duration-500 transform -translate-x-full bg-base-300 shadow-lg peer-checked:translate-x-0">
            <div class="px-6 py-4 flex flex-col justify-center items-center">
                <a href="https://discord.gg/J8pn9Kcm" target="_blank" rel="noreferrer"
                   class="nx-p-2 nx-text-current">
                    <svg width="24" height="24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"
                         viewBox="0 5 30.67 23.25"><title>Discord</title>
                        <path
